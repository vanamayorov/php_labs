            ...
            <div class="row main-screen__center">
                ...
                <div class="col-12 col-lg-6 main-screen__row">
                    <div class="main-screen__img-wrapper">
                        <img class="main-screen__img" src="assets/img/index/1.png" alt="Cars">
                    </div>
                </div>
            </div>
            <div class="row main-screen__services services">
                    ...
                    <article class="services-card">
                        <div class="services-card__icon-wrapper">
                            <svg class="services-card__svg">
                                <use xlink:href="assets/img/sprite.svg#services-1"></use>
                            </svg>
                        </div>
                ...
                <div class="col-lg-4">
                    <article class="services-card">
                        <div class="services-card__icon-wrapper">
                            <svg class="services-card__svg">
                                <use xlink:href="assets/img/sprite.svg#services-2"></use>
                            </svg>
                        </div>
                        <div class="services-card__content">
                            <h3 class="services-card__title">
                ...
                <div class="col-lg-4">
                    <article class="services-card">
                        <div class="services-card__icon-wrapper">
                            <svg class="services-card__svg">
                                <use xlink:href="assets/img/sprite.svg#services-3"></use>
                            </svg>
                        </div>
                        <div class="services-card__content">
                            <h3 class="services-card__title">
        ...
        <div class="row">
            <div class="col-12 col-lg-7">
                ...
                <div class="description-info working-sphere__desc">
                    Мы проводим опрос среди пользователей сайта, чтобы предоставить Вам информацию соответствующую сфере
                    Вашей
                    деятельности.
                </div>
...
<section class="why-us">
    <div class="container">
        <div class="why-us__banner">
            ...
            <div class="why-us__bg" style="background-image: url('assets/img/index/bg.png')"></div>
        </div>
        ...
        <ul class="row why-us__list">
                ...
                <article class="why-us-card">
                    <div class="why-us-card__icon-wrapper">
                        <svg class="why-us-card__svg">
                            <use xlink:href="assets/img/sprite.svg#why-us-1"></use>
                        </svg>
                    </div>
            ...
            <li class="col-sm-12 col-lg-6 why-us__item">
                <article class="why-us-card">
                    <div class="why-us-card__icon-wrapper">
                        <svg class="why-us-card__svg">
                            <use xlink:href="assets/img/sprite.svg#why-us-2"></use>
                        </svg>
                    </div>
            ...
            <li class="col-sm-12 col-lg-6 why-us__item">
                <article class="why-us-card">
                    <div class="why-us-card__icon-wrapper">
                        <svg class="why-us-card__svg">
                            <use xlink:href="assets/img/sprite.svg#why-us-3"></use>
                        </svg>
                    </div>
            ...
            <li class="col-sm-12 col-lg-6 why-us__item">
                <article class="why-us-card">
                    <div class="why-us-card__icon-wrapper">
                        <svg class="why-us-card__svg">
                            <use xlink:href="assets/img/sprite.svg#why-us-4"></use>
                        </svg>
                    </div>
        ...
        <div class="contact-us__inner">
            <div class="contact-us__left">
                <div class="contact-us__content">
                    ...
                    >
                        <textarea class="contact-us__textarea" name="task" placeholder="Опишите задачу..."
                                  required></textarea>
            ...
            <div class="contact-us__right">
                <img class="contact-us__img" src="assets/img/index/contact-bg.jpg" alt="Contact us background">
            </div>
        </div>
    </div>
</section>
<section class="video">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-12">
                ...
                <div class="description-info">
                    ...
                    et dolore magna aliqua. Elit duis tristique sollicitudin nibh sit amet. Ultrices eros in cursus
                    turpis massa tincidunt. Venenatis urna cursus eget nunc scelerisque viverra mauris in. Pharetra
        ...
        <div class="video__content">
            <div class="video__bg"
                 style="background-image: url('assets/img/index/video-bg.jpg')"
